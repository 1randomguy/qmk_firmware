...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LOWER]   = LAYOUT(
    ...
    KC_CAPS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,    _______, _______, _______, KC_MINUS, KC_EQUAL,\
  ...
  [DVORAK] = LAYOUT(
    ...
    KC_LCTRL,DF(0), KC_LGUI, KC_LALT, MO(5),   KC_SPC,KC_SPC,    MO(4),   KC_RALT, KC_PGUP, KC_PGDOWN, KC_RCTRL         \
  ),

  [UPPERD]   = LAYOUT(
    _______, KC_MPLY,    KC_MPRV,    KC_MNXT, KC_VOLD,    KC_VOLU, _______, _______, _______, _______, KC_RIGHT,   KC_DEL,  \
    _______, RALT(KC_Q), RALT(KC_P), _______, RALT(KC_Y), KC_MUTE, _______, KC_LEFT, _______, _______, RALT(KC_S), _______, \
  ...
  [LOWERD]   = LAYOUT(
    KC_GRV , KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_BSLS, \
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   _______, _______, _______, KC_SLSH, KC_EQUAL,\
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, KC_LBRC, KC_RBRC, _______, \
